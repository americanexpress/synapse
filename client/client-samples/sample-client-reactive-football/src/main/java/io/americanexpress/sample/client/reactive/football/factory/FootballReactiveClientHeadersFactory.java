...
/**
 * {@code FootballReactiveClientHeadersFactory} creates headers for the football reactive client.
 *
 * @author eperjust
 */
@Component
public class FootballReactiveClientHeadersFactory extends BaseClientHttpHeadersFactory<FootBallClientRequest> {
     ...
     */
    protected FootballReactiveClientHeadersFactory(ObjectMapper mapper) {
        super(mapper);
    }
