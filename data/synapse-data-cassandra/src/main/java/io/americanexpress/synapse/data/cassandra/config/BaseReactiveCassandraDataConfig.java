...
/**
 * {@code BaseCassandraDataConfig} class is used to hold the common configuration for all reactive data-cassandra modules.
 */
@Configuration
@EnableReactiveCassandraAuditing
@EnableReactiveCassandraRepositories
public abstract class BaseReactiveCassandraDataConfig extends AbstractReactiveCassandraConfiguration {
