 ...
 * the License.
 */
package io.americanexpress.data.oracle.book.reactive.config;
...
/**
 * {@code R2dbcDataBookConfig} example of using BaseR2dbcOracleConfig to enable reactive database calls
 */
@Configuration
