 ...
 * @author sazam3
 */
public enum CustomErrorCodes implements GenericErrorCode {

    /**
     * Used for all of the generic 4XX series errors, including the 4XX series errors received from external providers.
     */
    CUSTOM_BUSINESS_ERROR("CUSTOM_BUSINESS_ERROR", "A business rule was violated"),
    CUSTOM_VALIDATION_ERROR("CUSTOM_VALIDATION_ERROR", "Custom validation failed");
     ...
     */
    CustomErrorCodes(String code, String message) {
        this.code = code;
