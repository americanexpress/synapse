...
// * the License.
// */
//package io.americanexpress.synapse.function.rest.router.exceptionhandler;
//
...
//import io.americanexpress.synapse.function.rest.model.ErrorResponse;
...
//        ErrorResponse errorResponse = new ErrorResponse(ErrorCode.GENERIC_5XX_ERROR, GENERIC_5XX_HEADER_MESSAGE, message, fullStackTrace);
//
...
//        final ErrorResponse errorResponse = new ErrorResponse(ErrorCode.GENERIC_5XX_ERROR, GENERIC_5XX_HEADER_MESSAGE, message, fullStackTrace);
//
//        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(errorResponse);
//    }
//}
