...
/**
 * {@code UpdateBookHandler} is the entry point for the read function.
 */
public class UpdateBookHandler extends FunctionInvoker<Message<UpdateBookRequest>, CreateBookResponse> {

    /**
     * Executes read function upon request.
     *
    ...
    public HttpResponseMessage execute(
        ...
        Message<UpdateBookRequest> message = MessageBuilder.withPayload(request.getBody())
