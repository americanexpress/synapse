 ...
 */
@Component
public class ReadBookServiceResponseCreator {
     ...
     */
    public ReadBookServiceResponse create(BaseBook request) {

        var readBookServiceResponse = new ReadBookServiceResponse();
        readBookServiceResponse.setTitle(request.getTitle());
        readBookServiceResponse.setAuthor(request.getAuthor());
        readBookServiceResponse.setCost(request.getCost());
