...
public final class HelloServiceGrpc {
  ...
  public static final String SERVICE_NAME = "io.americanexpress.service.hello.reactive.grpc.HelloService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<io.americanexpress.service.hello.reactive.grpc.HelloRequest,
      io.americanexpress.service.hello.reactive.grpc.HelloResponse> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = io.americanexpress.service.hello.reactive.grpc.HelloRequest.class,
      responseType = io.americanexpress.service.hello.reactive.grpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<io.americanexpress.service.hello.reactive.grpc.HelloRequest,
      io.americanexpress.service.hello.reactive.grpc.HelloResponse> getSayHelloMethod() {
    io.grpc.MethodDescriptor<io.americanexpress.service.hello.reactive.grpc.HelloRequest, io.americanexpress.service.hello.reactive.grpc.HelloResponse> getSayHelloMethod;
    if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getSayHelloMethod = HelloServiceGrpc.getSayHelloMethod) == null) {
          HelloServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<io.americanexpress.service.hello.reactive.grpc.HelloRequest, io.americanexpress.service.hello.reactive.grpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.americanexpress.service.hello.reactive.grpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  io.americanexpress.service.hello.reactive.grpc.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(io.americanexpress.service.hello.reactive.grpc.HelloRequest request,
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public io.americanexpress.service.hello.reactive.grpc.HelloResponse sayHello(io.americanexpress.service.hello.reactive.grpc.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<io.americanexpress.service.hello.reactive.grpc.HelloResponse> sayHello(
        io.americanexpress.service.hello.reactive.grpc.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((io.americanexpress.service.hello.reactive.grpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<io.americanexpress.service.hello.reactive.grpc.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return io.americanexpress.service.hello.reactive.grpc.HelloWorldProto.getDescriptor();
    }
