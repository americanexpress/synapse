...
import io.americanexpress.service.book.rest.service.reactive.UpdateBookReactiveService;
import io.americanexpress.synapse.service.rest.controller.reactive.BaseUpdateReactiveController;
import org.springframework.web.bind.annotation.RequestMapping;
import org.springframework.web.bind.annotation.RestController;

/**
 * {@code ReadMonoBookReactiveController} emulates creating a Book resource.
 */
@RestController
@RequestMapping(BookConfig.BOOK_REACTIVE_ENDPOINT)
public class UpdateBookReactiveController extends BaseUpdateReactiveController<ReadPolyBookRequest, UpdateBookReactiveService> {
}
