...
/**
 * {@code CreateBookController} is the controller class for creating a book.
 */
@RestController
@RequestMapping(BookConfig.BOOK_ENDPOINT)
class CreateBookController : BaseCreateReactiveController<CreateBookRequest, CreateBookResponse, CreateBookService>() {
}