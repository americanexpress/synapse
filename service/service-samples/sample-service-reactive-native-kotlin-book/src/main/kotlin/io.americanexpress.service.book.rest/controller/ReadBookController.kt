...
/**
 * {@code ReadBookController} is the controller class for reading a book.
 */
@RestController
@RequestMapping(BookConfig.BOOK_ENDPOINT)
class ReadBookController : BaseReadMonoReactiveController<ReadBookRequest, ReadBookResponse, ReadBookService>() {
}