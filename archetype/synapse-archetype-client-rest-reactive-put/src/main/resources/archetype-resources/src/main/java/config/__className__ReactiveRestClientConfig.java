...
public class ${className}ReactiveRestClientConfig extends BaseReactiveRestClientConfig {
	 ...
	 */
	private final ${className}PutReactiveRestClient reactiveRestClient;
	 ...
	 */
	@Autowired
	public ${className}ReactiveRestClientConfig(${className}PutReactiveRestClient reactiveRestClient) {
