...
public class ${className}RestClientConfig extends BaseRestClientConfig {
	 ...
	 */
	private final ${className}PutRestClient restClient;
	 ...
	 */
	@Autowired
	public ${className}RestClientConfig(${className}PutRestClient restClient, ${className}RestResponseErrorHandler restResponseErrorHandler) {
