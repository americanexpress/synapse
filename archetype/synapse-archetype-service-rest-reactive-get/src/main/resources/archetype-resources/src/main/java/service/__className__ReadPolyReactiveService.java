...
/**
 * {@code ${className}ReadPolyReactiveService class is the service
 * used to connect to the ${apiName} REST API.
 * @author ${author}
 *
 */
@Service
public class ${className}ReadPolyReactiveService extends BaseReadPolyReactiveService<${className}PolyServiceRequest, ${className}ServiceResponse> {

	@Override
	protected Flux<${className}ServiceResponse> executeRead(HttpHeaders headers, ${className}PolyServiceRequest polyServiceRequest) {
