 ...
 */
@Service
public class ${className}ReactiveGetPolyRestService extends BaseGetPolyReactiveService<${className}ServiceResponse> {

	@Override
	protected Flux<${className}ServiceResponse> executeRead() {
