...
import ${package}.service.${className}ReadPolyReactiveService;
...
/**
 * {@code ${className}ReadPolyReactiveController} class is the controller
...
public class ${className}ReadPolyReactiveController extends BaseReadPolyReactiveController<${className}PolyServiceRequest, ${className}ServiceResponse, ${className}ReadPolyReactiveService> {
