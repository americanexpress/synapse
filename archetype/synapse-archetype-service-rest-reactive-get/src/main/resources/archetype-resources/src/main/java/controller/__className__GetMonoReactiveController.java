...
import ${package}.service.${className}GetMonoReactiveService;
import ${package}.model.${className}ServiceResponse;
import ${package}.config.${className}RestServiceEndpoint;

/**
 * {@code ${className}GetMonoReactiveController} class is the controller
...
public class ${className}GetMonoReactiveController extends BaseGetMonoReactiveController<${className}ServiceResponse, ${className}GetMonoReactiveService> {
