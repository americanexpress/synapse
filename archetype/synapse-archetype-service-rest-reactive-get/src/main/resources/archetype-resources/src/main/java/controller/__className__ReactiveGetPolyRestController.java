...
import ${package}.service.${className}ReactiveGetPolyRestService;
...
public class ${className}ReactiveGetPolyRestController extends BaseGetPolyReactiveController<${className}ServiceResponse, ${className}ReactiveGetPolyRestService> {
