...
import ${package}.service.${className}ReactiveGetMonoRestService;
...
public class ${className}ReactiveGetMonoRestController extends BaseGetMonoReactiveController<${className}ServiceResponse, ${className}ReactiveGetMonoRestService> {
