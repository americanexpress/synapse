...
import ${package}.service.${className}GetPolyReactiveService;
...
public class ${className}GetPolyReactiveController extends BaseGetPolyReactiveController<${className}ServiceResponse, ${className}GetPolyReactiveService> {
