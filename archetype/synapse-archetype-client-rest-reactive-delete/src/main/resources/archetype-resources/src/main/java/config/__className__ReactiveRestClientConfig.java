...
public class ${className}ReactiveRestClientConfig extends BaseReactiveRestClientConfig {
	 ...
	 */
	private final ${className}DeleteReactiveRestClient reactiveRestClient;
	 ...
	 */
	@Autowired
	public ${className}ReactiveRestClientConfig(${className}DeleteReactiveRestClient reactiveRestClient) {
