...
/**
 * {@code ${className}DeleteReactiveRestClientIT} class performs integration tests
 * for the {@link ${className}DeleteReactiveRestClient}.
 * <p>
...
class ${className}DeleteReactiveRestClientIT {

	@Autowired
	private ${className}DeleteReactiveRestClient reactiveRestClient;
